...
<transition name="slide" mode="out-in">
  <div class="login-wrap full-page">
    ...
    <div class="login-form">
      ...
      <div class="login-form-item">
        <input type="text" v-model="invitationCode" placeholder="请输邀请码" autofocus>
        <cube-validator v-model="invitationValid" :model="invitationCode" :rules="invitationRules" :messages="invitationMessages"></cube-validator>
      </div>
      <div class="login-form-item">
      ...
      <router-link to="/login" tag="div" class="toSignup">
        <span>< 登&nbsp;&nbsp;陆</span>
      </router-link>
